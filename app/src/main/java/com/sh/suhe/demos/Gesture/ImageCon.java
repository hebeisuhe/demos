...
/**
 * Created by suhe on 2017/3/15.
 * com.sh.suhe.demos.Gesture
 */

public class ImageCon extends AppCompatImageView {
    public ImageCon(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
    }

    public ImageCon(Context context, AttributeSet attrs) {
        super(context, attrs);
        // TODO Auto-generated constructor stub
    }

    public ImageCon(Context context, AttributeSet attrs, int defStyle) {
    ...
    float limitY1;
    float limitY2;
    ImageCon .ICustomMethod mCustomMethod = null;
    ...
    public void imageInit(Bitmap bitmap, int contentW, int contentH,
                          int topHeight, ImageCon .ICustomMethod iCustomMethod) {
